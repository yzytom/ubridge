...
static int frequency_drop_handler(void *pkt, int len, void *opt)
{
   struct frequency_drop_data *data = opt;
...
static int packet_loss_handler(void *pkt, int len, void *opt)
{
   struct packet_loss_data *data = opt;
...
static int delay_handler(void *pkt, int len, void *opt)
{
   struct delay_data *data = opt;
   int delay;
...
static void corrupt_packet(char *pkt, int len, void *opt)
{
   struct corrupt_data *data = opt;
   int i;
...
static int corrupt_handler(void *pkt, int len, void *opt)
{
   struct corrupt_data *data = opt;
   int length;
...
static int bpf_handler(void *pkt, int len, void *opt)
{
   struct bpf_data *data = opt;
